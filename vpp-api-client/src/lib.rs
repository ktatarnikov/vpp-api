...
cfg_if! {
    if #[cfg(feature = "26_02")] {

        #[path = "../gen/26.02/src/mod.rs"]
        #[rustfmt::skip]
        #[allow(clippy::all)]
        pub mod client;
        ...
        #[cfg(test)]
        #[path = "../gen/26.02/tests/afunix_interface_test.rs"]
        #[rustfmt::skip]
        #[allow(clippy::all)]
        pub mod tests_afunix;

        #[cfg(test)]
        #[path = "../gen/26.02/tests/blocking_interface_test.rs"]
        #[rustfmt::skip]
        #[allow(clippy::all)]
        pub mod tests_blocking;

        #[cfg(test)]
        #[path = "../gen/26.02/tests/nonblocking_interface_test.rs"]
        #[rustfmt::skip]
        #[allow(clippy::all)]
        pub mod tests_nonblocking;

    } else if #[cfg(feature = "25_10")] {
        ...
        compile_error!("You must enable exactly one version feature: e.g. `26_02`, `25_10`, or `25_06`");
    }
}
